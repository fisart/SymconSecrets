...
// Use absolute paths so the library works when loaded by the IP-Symcon module
// regardless of the process working directory.
require_once __DIR__ . '/WebAuthnException.php';
require_once __DIR__ . '/Binary/ByteBuffer.php';
require_once __DIR__ . '/Attestation/AttestationObject.php';
require_once __DIR__ . '/Attestation/AuthenticatorData.php';
require_once __DIR__ . '/Attestation/Format/FormatBase.php';
require_once __DIR__ . '/Attestation/Format/None.php';
require_once __DIR__ . '/Attestation/Format/AndroidKey.php';
require_once __DIR__ . '/Attestation/Format/AndroidSafetyNet.php';
require_once __DIR__ . '/Attestation/Format/Apple.php';
require_once __DIR__ . '/Attestation/Format/Packed.php';
require_once __DIR__ . '/Attestation/Format/Tpm.php';
require_once __DIR__ . '/Attestation/Format/U2f.php';
require_once __DIR__ . '/CBOR/CborDecoder.php';
